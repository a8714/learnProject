...
import com.atguigu.CourseFeignClient;
...
public class MessageServiceImpl implements MessageService {
    ...
    private String aboutUs(Map<String, String> param) {
        return this.text(param, "1111111111111111、HTML5前端+全栈、大数据、全链路UI/UE设计、人工智能、大数据运维+Python自动化、Android+HTML5混合开发等多门课程；同时，通过视频分享、谷粒学苑在线课堂、大厂学苑直播课堂等多种方式，满足了全国编程爱好者对多样化学习场景的需求，已经为行业输送了大量IT技术人才。").toString();
    }
    ...
    public void pushPayMessage(long orderId) {
        String openid = "om-Zv6QuSZnP90oud2NzPscULMuI";
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)//要推送的用户openid
                .templateId("AYtFkXNeViCorhpR7fLe1-QXnJ2zEuO_4hA7n-bC3qU")//模板id
